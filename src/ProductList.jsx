        ...
        <div>
            ...
            {!showCart? (
                <div className="product-grid">
                    {plantsArray.map((plantTypes, plantTypesIndex) => (
                        <div className='product-list' key={plantTypesIndex}>
                            <div className='product-list'><h1>{plantTypes.category}</h1></div>
                            {plantTypes.plants.map((plant, plantIndex) => (
